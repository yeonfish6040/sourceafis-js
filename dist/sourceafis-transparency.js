...
exports.getTransparencyClasses = getTransparencyClasses;
exports.withTransparencyZip = withTransparencyZip;
const sourceafis_1 = require("./sourceafis");
const java = require("java");
let transparencyClasses = null;
function getTransparencyClasses() {
...
function withTransparencyZip(zipPath, fn) {
    const loaded = (0, sourceafis_1._getClasses)();
